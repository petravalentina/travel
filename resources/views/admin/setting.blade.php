                    ...
                    <form action="{{ route('admin_setting_update',$setting_data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Travel & Tour Feature Status</label>
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Travel & Tour Total</label>
                                    <input type="text" class="form-control" name="home_room_total" value="{{ $setting_data->home_room_total }}">
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Travel & Tour Status</label>
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Travel & Tour Testimonial Status</label>
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Travel & Tour Latest Post Total</label>
                                    <input type="text" class="form-control" name="home_latest_post_total" value="{{ $setting_data->home_latest_post_total }}">
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Travel & Tour Latest Post Status</label>
