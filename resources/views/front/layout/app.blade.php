...
<html lang="en">
    <head>
        ...
        <title>Indonesia Travel Guide</title>
                    ...
                    <div class="col-md-6 right-side">
                        <ul class="right">
                            ...
                            @else
                                ...
                                <li class="menu"><a href="{{ route('transaksi') }}" style="color:white !important;">Transaksi</a></li>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a href="javascript:void;" class="nav-link dropdown-toggle">Travel & Tour</a>
        ...
        <div class="footer">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <ul class="social">
                                ...
                                <li><a href="{{ $global_setting_data->facebook }}" style="background-color: #000000 !important;"><i class="fa fa-facebook-f"></i></a></li>
                                @endif

                                @if($global_setting_data->twitter != '')
                                <li><a href="{{ $global_setting_data->twitter }}" style="background-color: #000000 !important;"><i class="fa fa-twitter"></i></a></li>
                                @endif

                                @if($global_setting_data->linkedin != '')
                                <li><a href="{{ $global_setting_data->linkedin }}" style="background-color: #000000 !important;"><i class="fa fa-linkedin"></i></a></li>
                                @endif

                                @if($global_setting_data->pinterest != '')
                                <li><a href="{{ $global_setting_data->pinterest }}" style="background-color: #000000 !important;"><i class="fa fa-pinterest-p"></i></a></li>
                                @endif
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            <h2 class="heading">Download App</h2>
                            <img importance="low" loading="lazy" src="https://d1785e74lyxkqq.cloudfront.net/_next/static/v2/f/f519939e72eccefffb6998f1397901b7.svg" decoding="async" style="object-fit: fill; object-position: 50% 50%;">
                            <img importance="low" loading="lazy" src="https://d1785e74lyxkqq.cloudfront.net/_next/static/v2/1/18339f1ae28fb0c49075916d11b98829.svg" decoding="async" style="object-fit: fill; object-position: 50% 50%;">
                        </div>
                    </div>
