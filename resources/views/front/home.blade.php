...
<div class="search-section">
    <div class="container">
        <form action="{{ route('cart_submit') }}" method="post" autocomplete="off">
            @csrf
            <div class="inner">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            <select name="room_id" class="form-select">
                                <option value="">Choose Travel & Tour</option>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <input type="text" name="checkin_checkout" class="form-control daterange1" placeholder="Tour Date">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
                            <input type="number" name="adult" class="form-control" min="1" max="30" placeholder="Adult">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
...
<div class="home-rooms">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="main-header">Travel & Tour</h2>
            </div>
        </div>
        <div class="row">
            @foreach($room_all as $item)
            ...
            <div class="col-md-3">
                <div class="inner">
                    ...
                    <div class="text">
                        ...
                        <div class="button">
                            <a href="{{ route('room_detail',$item->id) }}" class="btn btn-primary">Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="big-button">
                    <a href="{{ route('room') }}" class="btn btn-primary">Lihat Semua Tour</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="testimonial" style="background-image: url(uploads/Bali.jpg)">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
...
<div class="blog-item">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="main-header">Popular Destinations</h2>
            </div>
        </div>
        <div class="row">
