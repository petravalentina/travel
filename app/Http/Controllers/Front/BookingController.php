...
class BookingController extends Controller
{
    ...
    public function cart_submit(Request $request)
    {
        ...
        if($cnt == 0) {
            return redirect()->back()->with('error', 'Maximum number of this Travel is already booked');
        }
        ...
        return redirect()->back()->with('success', 'Travel is added to the cart successfully.');
    }
    ...
    //RENCANAKU INI DIHAPUS AJA, POKOKNYA YANG BERHUBUUNGAN SAMA MIDTRANS HAPUS AJA
